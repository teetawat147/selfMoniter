    ...
    <form action="healthDataRecordInsert.php" method="POST">
        <div class="form-row">   
            <div class="form-group col-md-12">
                <label for="smokeId">คุณเป็นโรคเบาหวานใช่หรือไม่</label><br>
        ...
        <div class="form-row">
            <div class="form-group col-md-6">
                ...
                <input name="healthHeight" id="healthHeight" type="text" class="form-control" value="<?php echo $_SESSION['personHeight']; ?>" Readonly>
            </div>
