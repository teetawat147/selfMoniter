...
<body>
    ...
    <fieldset id="officeGetUpdate" style="display:block;">
        <div class = "container">
          <center><h3>แก้ไขข้อมูลหน่วยงาน</h3></center>
          <br>
            ...
            <div  class="form-group col-md-6">
                ...
                <select name='office_type' id='office_type' class='form-control' required data-error-msg="กรุณาเลือกประเภทหน่วยงาน" >
                    ...
                    while($row = $result->fetch()) {
                        ?>
                         <option value="<?php echo $row['hostypecode'];?>" <?php echo ($rowEdit['hostypecode']==$row['hostypecode'])?"selected":"";?>><?php echo $row['hostypename'];?></option>
                        <?php   
                    }
                    ?>
                </select>
