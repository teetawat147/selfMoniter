        ...
        <div class ="container">
            ...
            <div class="form-row d-flex justify-content-center">
                <div class="form-group col-md-6">
                    ...
                    <input name="departmentName" id="departmentName" class="form-control" min="3" type="text" value="" placeholder="กรุณากรอกชื่อแผนกงาน">
                </div>

                <div class="form-group col-md-6">
                    <label for="countPersonDept">จำนวนเจ้าหน้าที่ในแผนกงาน</label>
                    <input name="countPersonDept" id="countPersonDept" class="form-control" min="3" type="text" value="" placeholder="กรุณากรอกจำนวนเจ้าหน้าที่ในแผนกงาน">
                </div>
